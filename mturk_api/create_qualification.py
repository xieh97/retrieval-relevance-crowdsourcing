...
response = client.create_qualification_type(
    Name="TAU-ARG audio-text matching test",
    Keywords="TAU-ARG audio rating, audio-text matching",
...
#
# %% TAU-ARG HIT accuracy

response = client.create_qualification_type(
    Name="Accuracy on TAU-ARG HITs",
    Keywords="TAU-ARG audio rating, audio-text matching",
    Description="This number indicates your accuracy score on previous TAU-ARG HITs.",
    QualificationTypeStatus="Active",
    AutoGranted=True,
    AutoGrantedValue=100
)
